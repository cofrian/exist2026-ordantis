...
MAX_TOK = 1100
P1, P2, PAT = 2, 8, 3
CKPT = os.path.join(ALT, "vista_e_task23_longformer_v2_best.pt")

# reutilizar load_t23, DS23, gold_hard, pred_hard, pyevall_* del max512
from task23_max512_v2 import load_t23, DS23, cat_posw, sampler_for, loss_fn, gold_hard, pred_hard, pyevall_hard, pyevall_soft
...
def main():
    ...
    print(f"[EXP-B 2.3 Longformer+SAMPLER] {LONG_MODEL} MAX_TOK={MAX_TOK}", flush=True)
    splits = load_t23()
